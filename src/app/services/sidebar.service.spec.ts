...
describe('SidebarService', () => {
  ...
  describe('core functionality', () => {
    ...
    it('should close sidebar and clear item ID after delay', fakeAsync(() => {
      // Open sidebar first
    ...
    it('should not clear item ID if sidebar is reopened during animation', fakeAsync(() => {
  ...
  describe('edge cases', () => {
    it('should handle router events during close animation', fakeAsync(() => {
      service.openSidebar(123);
      service.closeSidebar();

      // Emit navigation event during animation
      tick(150); // Halfway through 300ms timeout
      mockRouter.emitNavigationEnd();
