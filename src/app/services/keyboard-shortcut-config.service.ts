...
export class KeyboardShortcutConfigService {
  ...
  private shortcuts: KeyboardShortcut[] = [
    ...
    },
    {
      key: 'u',
      contexts: ['sidebar'],
      description: 'Jump to next unread comment',
      category: 'Comment Actions',
      commandId: 'sidebar.nextUnreadComment',
    },
    {
      key: 'p',
      contexts: ['sidebar'],
      description: 'Jump to next OP reply',
      category: 'Comment Actions',
      commandId: 'sidebar.nextOPComment',
    },
    {
      key: 'E',
      label: 'Shift+e',
      contexts: ['sidebar'],
      description: 'Expand all visible comments',
      category: 'Comment Actions',
      commandId: 'sidebar.expandAllComments',
    },
    {
      key: 'C',
      label: 'Shift+c',
      contexts: ['sidebar'],
      description: 'Collapse all visible comments',
      category: 'Comment Actions',
      commandId: 'sidebar.collapseAllComments',
    },
    {
      key: 'o',
      contexts: ['sidebar'],
    ...
    },
    {
      ...
      description: 'Jump to next unread comment',
      category: 'Comment Actions',
      commandId: 'item.nextUnreadComment',
    },
    {
      key: 'p',
      contexts: ['item-page'],
    ...
    },
    {
      ...
      description: 'Expand all visible comments',
      category: 'Comment Actions',
      commandId: 'item.expandAllComments',
    },
    {
      key: 'C',
      label: 'Shift+c',
      ...
      description: 'Collapse all visible comments',
      category: 'Comment Actions',
      commandId: 'item.collapseAllComments',
    },
    {
      key: 'Escape',
      label: 'Esc',
